...
final class TypeUtils
{
    ...
    static String getArrayElementPgTypeName(ConnectorSession session, KingBaseClient client, Type elementType)
    {
    ...
    static KBobject toPgTimestamp(LocalDateTime localDateTime)
            throws SQLException
    {
        KBobject kbObject = new KBobject();
        kbObject.setType("timestamp");
        kbObject.setValue(localDateTime.toString());
        return kbObject;
    }
}
