        ...
        extends BaseJdbcClient
{
    ...
    public WriteMapping toWriteMapping(ConnectorSession session, Type type)
    {
        ...
        if (type instanceof ArrayType arrayType && PostgreSqlSessionProperties.getArrayMapping(session) == PostgreSqlConfig.ArrayMapping.AS_ARRAY) {
        ...
        if (isVarchar) {
            ...
            switch (operator) {
                ...
                case GREATER_THAN_OR_EQUAL:
                    return PostgreSqlSessionProperties.isEnableStringPushdownWithCollate(session);
                case EQUAL:
                case NOT_EQUAL:
