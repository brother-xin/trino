...
import static io.trino.plugin.opengauss.PostgreSqlQueryRunner.createPostgreSqlQueryRunner;
        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testArrayDisabled()
    {
        Session session = Session.builder(getSession())
                .setCatalogSessionProperty("postgresql", PostgreSqlSessionProperties.ARRAY_MAPPING, PostgreSqlConfig.ArrayMapping.DISABLED.name())
                .build();
    ...
    {
        Session session = Session.builder(getSession())
                .setSystemProperty("postgresql.array_mapping", PostgreSqlConfig.ArrayMapping.AS_JSON.name())
                .build();
...
//                    .isNotFullyPushedDown(AggregationNode.class);
    ...
    private Session sessionWithArrayAsArray()
    {
        return Session.builder(getSession())
                .setSystemProperty("postgresql.array_mapping", PostgreSqlConfig.ArrayMapping.AS_ARRAY.name())
                .build();
    }
